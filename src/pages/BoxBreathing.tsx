  ...
  return (
    <PageContainer withBottomNav={false}>
      <div className="min-h-screen flex flex-col">
        <header className="bg-gradient-to-b from-secondary/10 to-background px-6 pt-12 pb-6">
          <button
          ...
          <h1 className="text-2xl font-bold">{t('mental.box.title')}</h1>
          <p className="text-muted-foreground mt-1">{t('mental.box.subtitle')}</p>
        </header>
